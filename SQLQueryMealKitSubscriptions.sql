...
--INSERT INTO Customers (FullName, Email, SubscriptionLevel, SubscriptionStartDate, SubscriptionEndDate, State) VALUES
--('Bill Grates', 'billgrates@michaelsoft.com', 'Premium', '2024-03-13', '2026-12-31', 'CA');

--UPDATE Customers
--SET SubscriptionLevel='Premium'
--WHERE UserID = 25;
...
--INSERT INTO Meals (MealName, Calories, Price, IsVegetarian, SubscriptionLevel) VALUES
--('Deluxe Pizza', 900, 20.00, 0, 'Standard'),
--('Chicken Breast', 550, 12.00, 0, 'Standard'),
--('Very Fance Pasta', 1300, 30, 1, 'Premium');
...
--SELECT AVG(Price) AS 'Average', MAX(Price) AS 'Max', MIN(Price) AS 'Min' FROM Meals;
